        ...
        <main className="glass" style={{ padding: '3rem', borderRadius: '16px', border: '1px solid var(--border-color)', background: 'white' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '2.5rem', alignItems: 'center' }}>
            ...
            <div className="inner-split" style={{ display: 'contents' }}>
              <div>
                <h3 style={{ color: '#000000', fontSize: '1.25rem', marginBottom: '1rem', fontWeight: 700 }}>Scope of Operations</h3>
          ...
          <div className="glass" style={{ marginTop: '3rem', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(14,165,233,0.15)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.5rem', background: 'white' }}>
            <div>
              <h4 style={{ color: '#000000', fontSize: '1.1rem', fontWeight: 700, marginBottom: '0.25rem' }}>Need this infrastructure service?</h4>
              <p style={{ color: '#666666', fontSize: '0.85rem' }}>Get in touch with our certified engineers to plan your site configuration.</p>
            </div>
