...
export default function Login() {
  ...
  const handleMockGoogleLogin = () => {
    // High-fidelity prompt to mock Google Sign-in
    ...
    <div className="container-width animate-fade-in" style={{ paddingTop: '5rem', maxWidth: '500px' }}>
      ...
      <div className="form-card glass" style={{ background: 'white', padding: '2.5rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '1.5rem 0' }}>
          ...
          <span style={{ fontSize: '0.85rem', color: '#6b7280', fontWeight: 500 }}>or sign in with</span>
          <div style={{ flex: 1, height: '1px', background: '#e5e7eb' }}></div>
        </div>
        ...
        {/* Google Mock sign-in (highly useful fallback for testing on Render) */}
        <button
          type="button"
